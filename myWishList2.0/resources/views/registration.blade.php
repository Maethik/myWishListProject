...
<div class="flex flex-col justify-center items-center w-full h-[100vh]">
    <div class="w-1/2 flex justify-center items-center">
        ...
        <div class="form-container w-full h-[50px] mb-1 px-5 py-1 border-2 border-red-400 rounded-lg bg-red-300 flex items-center">{{ session('success') }}</div>
    ...
    <div class="form-container bg-[#dac9bd] shadow-2xl rounded-3xl w-1/2 h-[75vh] flex flex-col items-center">
        ...
        <div class="w-full h-[75%] flex flex-col justify-center items-center">
            <h1 class="text-4xl mb-10">Inscription</h1>
            <form action="{{ route('registration.post') }}" method="POST" class="w-full flex flex-col items-center justify-around">
                @csrf
                <div class="flex flex-col mb-5">
                    <label>Nom d'utilisateur</label>
                    <input class="form-input rounded-lg px-2 py-1" type="text" name="name">
                </div>
                <div class="flex flex-col mb-5">
                ...
                <button class="text-xl text-white text-center bg-[#c1a793] hover:bg-[#b08e75] mt-10 px-3 py-1 rounded-xl" type="submit" >S'inscrire</button>
            </form>
        </div>
    </div>
</div>        
